# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 18:03:00 2015
...
nPoints = 10000 # could make a list and run for different numbers of points
...
xvalMSE = []
nxval = 10 # cross-validation amount; test set = 1/nxval
